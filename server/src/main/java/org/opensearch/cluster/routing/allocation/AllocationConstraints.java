...
import org.opensearch.cluster.routing.allocation.allocator.LocalShardsBalancerBalancer;
...
public class AllocationConstraints {
    ...
    class ConstraintParams {
        private LocalShardsBalancerBalancer balancer;
        private BalancedShardsAllocator.ModelNode node;
        private String index;

        ConstraintParams(LocalShardsBalancerBalancer balancer, BalancedShardsAllocator.ModelNode node, String index) {
     ...
     */
    public long weight(LocalShardsBalancerBalancer balancer, BalancedShardsAllocator.ModelNode node, String index) {
