...
public class AllocationConstraints {
    ...
    class ConstraintParams {
        private LocalShardsBalancer balancer;
        private BalancedShardsAllocator.ModelNode node;
        private String index;

        ConstraintParams(LocalShardsBalancer balancer, BalancedShardsAllocator.ModelNode node, String index) {
     ...
     */
    public long weight(LocalShardsBalancer balancer, BalancedShardsAllocator.ModelNode node, String index) {
