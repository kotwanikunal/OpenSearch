    ...
    public static Set<Setting<?>> BUILT_IN_CLUSTER_SETTINGS = Collections.unmodifiableSet(
        new HashSet<>(
            Arrays.asList(
                ...
                RecoverySettings.INDICES_RECOVERY_LIMIT_REMOTE_STREAMS_SETTING,
                RecoverySettings.INDICES_RECOVERY_USE_MULTISTREAM_DOWNLOADS,
                RecoverySettings.INDICES_RECOVERY_USE_VIRTUAL_THREADS_SETTING,
